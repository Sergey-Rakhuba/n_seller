...
export default function Card(Image, Title, Index, Text, Buttons, TagColor) {
    return (
        <>
            <div className="card_block">
                <img src="../../../public/users/9dc9049feb4a79dfd5f930926e7ac9b20a3e0a55.png" alt="" />
                <div className="card_content">
                    <p className='card_itm-group'>123 Main St, Anytown, USA</p>
                    <h3 className='card_itm-name'>Beautiful Family House</h3>
                    <div className='card_itm-block_params'>
                        {/* <span>{ItemYear} год выпуска</span>
                                                    <span>{ItemMassa} вес</span>
                                                    <span>{Itemmileage} mileage</span> */}
                    </div>
                </div>
                <br />
                <div className="card_btn-block">
                    ...
                    {/* <button className="card_btn-edit">Редактировать</button>
                                            <button className="card_btn-del">Удалить</button> */}
